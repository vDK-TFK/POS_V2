...
export default function IngresarInfoEmpresa({ open, onClose }) {

   async function agregarInfoEmpresa() {
            ...
            <div className="flex flex-col items-center">
               <div className="text-center w-full">
                  <h2 className="text-xl font-bold flex gap-3 justify-center items-center text-gray-900 dark:text-gray-100">
                     <CircleAlert />Ingresar Info. Empresa
                  </h2>
                  <hr className="my-3 py-0.5  border-black dark:border-white" />
                  <p className="text-md text-gray-800 dark:text-gray-100">
                     No existe agregada la información de la empresa.
                  </p>
                  <p className="text-md text-gray-800 dark:text-gray-100">
                     Debe agregarla para poder facturar.
                  </p>
                  
               </div>
               <form className="my-2 w-full flex flex-col items-center">
                  <div className="flex justify-center gap-6 mt-5">
                     <HtmlButton onClick={agregarInfoEmpresa} color={"green"} legend={"Agregar Info."} icon={Building} />
